      ...
      {isOpen && (
        <div className="fixed inset-0 z-40">
          ...
          <Motion.div
            ...
            animate="visible"
            exit="exit"
            className="fixed inset-y-0 left-0 top-20 lg:top-0 w-full md:w-[38rem] bg-white dark:bg-bg-200 sm:rounded-r-2xl shadow-2xl z-50 pr-8 lg:pl-[120px] overflow-y-auto"
